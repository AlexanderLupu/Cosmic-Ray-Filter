...
# Global lists to hold charges for channels 0..47
...
DATA_FOLDER       = "/Users/alexlupu/github/dune-apex-umn/DATA/" + DEFAULTS["raw_data_folder_name"] + "/jsonData/"
...
def show_event(adc, run_time, event_id,
    ...
    csv_file_path = os.path.join(csv_file_dir, "plot_names_{raw_data_folder_name}.csv")
...
def plot_cosmic_events_from_csv():
    ...
    for row in rows:
        ...
        out_subdir   = os.path.join(COSMIC_FROM_CSV_DIR, "cosmic_from_csv", f"{json_fname}_Evt{raw_evt_idx}")
